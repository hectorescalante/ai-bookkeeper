...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_provider_invoices_date", "provider_invoices", ["invoice_date"], unique=False
    )
    op.create_index(
        op.f("ix_provider_invoices_provider_id"), "provider_invoices", ["provider_id"], unique=False
    )
    op.create_table(
        "client_invoices",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        "ix_client_invoices_bl_reference", "client_invoices", ["bl_reference"], unique=False
    )
    op.create_index(
        op.f("ix_client_invoices_client_id"), "client_invoices", ["client_id"], unique=False
    )
